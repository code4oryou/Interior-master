    ...
    <div className="home">
      ...
      <div className="home-experience">
        <div className="h-years">
          <CountUp className="h-year num" duration={3} end={5} />
          <p>Years Of Experience</p>
        </div>
        <div className="h-s-project">
          <CountUp duration={3} className="h-sp num" end={35} />
          <p>Success Project</p>
        </div>
        <div className="h-a-project">
          <CountUp duration={3} className="h-ap num" end={6} />
          <p>Active Project</p>
        </div>
        <div className="h-customers">
          <CountUp duration={3} className="h-cust num" end={55} />
          <p>Happy Customers</p>
        </div>
      </div>
